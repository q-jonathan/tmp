const {pawn, knight, bishop, rook, queen, king} = require('./pieceTables.js');


function pieceValue(piece, squareName, color){
...
exports.pieceValue = pieceValue
exports.intToSquare = intToSquare
exports.squareToInt = squareToInt