...
exports.handler = async (event) => {
  var currentFen = event.body.fen;
  // let explorer = event.body.explorer
  var engineColor = event.body.colorToMove;
  var currentEval = event.body.currentEval;
  var searchDepth = event.body.searchDepth
